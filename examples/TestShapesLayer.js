...
requirejs(['../src/WorldWind',
    ...
    function (ww,
        ...
        var testLayer = new WorldWind.RenderableLayer();
        testLayer.displayName = "Test";
        ...
        var testShape = new WorldWind.shape(boundaries, null);
        testShape.altitudeMode = WorldWind.ABSOLUTE;
        testShape.extrude = true; // extrude the polygon edges to the ground

        var testShapeAttributes = new WorldWind.ShapeAttributes(null);
        testShapeAttributes.drawInterior = true;
        testShapeAttributes.drawOutline = true;
        testShapeAttributes.outlineColor = WorldWind.Color.BLUE;
        testShapeAttributes.interiorColor = new WorldWind.Color(0, 1, 1, 0.5);
        testShapeAttributes.drawVerticals = testShape.extrude;
        testShapeAttributes.applyLighting = true;
        testShape.attributes = testShapeAttributes;

        // Create and assign the polygon's highlight attributes.
        var highlightAttributes = new WorldWind.ShapeAttributes(testShapeAttributes);
        highlightAttributes.outlineColor = WorldWind.Color.RED;
        highlightAttributes.interiorColor = new WorldWind.Color(1, 1, 1, 0.5);
        testShape.highlightAttributes = highlightAttributes;

        // Add the polygon to the layer and the layer to the World Window's layer list.
        testLayer.addRenderable(testShape);
        ...
        testShape = new WorldWind.shape(boundaries, null);
        testShape.altitudeMode = WorldWind.ABSOLUTE;
        testShape.extrude = true;
        testShape.textureCoordinates = [
            [new WorldWind.Vec2(0, 0), new WorldWind.Vec2(1, 0), new WorldWind.Vec2(1, 1), new WorldWind.Vec2(0, 1)]
        ];

        testShapeAttributes = new WorldWind.ShapeAttributes(null);
        // Specify a texture for the polygon and its four extruded sides.
        testShapeAttributes.imageSource = [
        ...
        testShapeAttributes.drawOutline = true;
        testShapeAttributes.outlineColor = WorldWind.Color.BLUE;
        testShapeAttributes.interiorColor = WorldWind.Color.WHITE;
        testShapeAttributes.drawVerticals = shape.extrude;
        testShapeAttributes.applyLighting = true;
        testShape.attributes = testShapeAttributes;
        highlightAttributes = new WorldWind.ShapeAttributes(shapeAttributes);
        highlightAttributes.outlineColor = WorldWind.Color.RED;
        testShape.highlightAttributes = highlightAttributes;
        ...
        testShapeAttributes = new WorldWind.ShapeAttributes(null);
        testShapeAttributes.imageSource = "../images/400x230-splash-nww.png";
        testShapeAttributes.drawInterior = true;
        testShapeAttributes.drawOutline = true;
        testShapeAttributes.outlineColor = WorldWind.Color.BLUE;
        testShapeAttributes.interiorColor = WorldWind.Color.WHITE;
        testShapeAttributes.drawVerticals = testShapen.extrude;
        testShapeAttributes.applyLighting = true;
        testShape.attributes = testShapeAttributes;
